...
var DB = {
  ...
  load() {
    ...
    const d = this._data;
    ['users','products','sales','customers','suppliers','expenses','employees','payroll','notifications','payments','allocations','purchaseOrders','grns','supplierBills','quotations','employeeLoans','businesses','branches','customRoles','auditLogs','activityLogs']
