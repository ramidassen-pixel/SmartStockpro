'use strict';
const PAGES = ['dashboard','products','sales','customers','suppliers','expenses','salary','finance','reports','ai','settings','more'];
const BN_PAGES = ['dashboard','sales','products','customers','more'];
