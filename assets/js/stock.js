...
var Stock = {
  ...
  render: function() {
    ...
    pg.innerHTML = '<div class="page-header">'
      ...
      + '<div class="kpi" style="--kc:var(--g);--kibg:var(--gb)"><div class="kpi-icon">📥</div><div class="kpi-label">Units In</div><div class="kpi-value">'+totalIn+'</div><div class="kpi-sub">all time</div></div>'
      + '<div class="kpi" style="--kc:var(--in);--kibg:var(--inb)"><div class="kpi-icon">📤</div><div class="kpi-label">Units Out</div><div class="kpi-value">'+totalOut+'</div><div class="kpi-sub">all time</div></div>'
      ...
      + (lowStock.length ? '<div class="sec"><div class="sec-title">⚠️ Low Stock Alert ('+lowStock.length+')</div>'
        ...
        + lowStock.map(function(p){
            ...
            return '<div class="list-item" onclick="Stock.openAdjustProduct(\''+p.id+'\',\''+Utils.esc(p.name)+'\')">'
              ...
              + '<div style="font-size:20px;font-weight:900;color:'+col+'">'+p.qty+'</div>'
          ...
          ? '<div class="card">'
            + movements.slice(0,50).map(function(mv){
                ...
                return '<div class="list-item">'
                  ...
                  + '</div>'
                  + '<div class="list-right">'
                  + '<div style="font-size:18px;font-weight:900;color:'+color+'">'+(isIn?'+':'')+mv.qty+'</div>'
